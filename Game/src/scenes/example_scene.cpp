...
namespace Scenes {
    void ExampleScene::SetupScene() {
        ...
        floor_transform.m_parent = g_ecs.GetSystem<CameraSystem>()->GetActiveCameraEntity();
        RigidBody floor_rigidbody;
        Collider2D floor_collider;
        floor_collider.m_shape = Collider2D::ColliderShape::Square;
        ...
        floor_shape.m_color = {0, 255, 0, 255};
