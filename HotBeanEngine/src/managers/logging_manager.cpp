...
namespace HBE::Managers {
    ...
    LoggingManager::LoggingManager() : m_testing(true) {
        SetupDefaultLoggingPath();
    }
    ...
    void LoggingManager::Log(const LoggingType type, std::string message,
        ...
        switch (type) {
            case LoggingType::DEBUG:   level_tag = "[DEBUG] "; break;
            case LoggingType::INFO:    level_tag = "[INFO] "; break;
            case LoggingType::WARNING: level_tag = "[WARNING] "; break;
            case LoggingType::ERROR:   level_tag = "[ERROR] "; out_stream = &std::cerr; break;
            case LoggingType::FATAL:   level_tag = "[FATAL] "; out_stream = &std::cerr; break;
        }
    ...
    LoggingType LoggingManager::GetLoggingLevel() {
        return m_log_level;
    }
