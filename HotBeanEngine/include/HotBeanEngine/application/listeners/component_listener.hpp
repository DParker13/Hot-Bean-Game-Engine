...
namespace HBE::Application::Listeners {
    ...
    public:
         ...
         */
        void ListenForComponents(const std::unordered_set<Core::ComponentID> &component_ids) {
         ...
         */
        virtual void OnComponentAdded(Core::IComponent *component, Core::EntityID entity) = 0;
