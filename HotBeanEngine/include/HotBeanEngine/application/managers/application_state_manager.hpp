/**
 * @file application_state_manager.hpp
 * @author Daniel Parker (DParker13)
 * @brief Manages application state transitions and control.
 * @version 0.1
 * @date 2025-12-09
 *
...
namespace HBE::Application::Managers {
    ...
    /**
     * @brief Controls application state transitions and manages pause/resume/stop logic.
     *
     * This class encapsulates the state machine logic for the application, providing
